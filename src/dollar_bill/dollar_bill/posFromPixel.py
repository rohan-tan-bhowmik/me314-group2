...
class PixelToCoordNode(Node):
    def __init__(self):
        ...
        self.DollarObjectCenter = "/image_dollar_center"
        ...
        self.create_subscription(Point, self.DollarObjectCenter, lambda msg: self.getPointInBaseFrame(msg, "dollar"), 10)
        ...
        self.publisher_dollar = self.create_publisher(Point, 'dollar_position', 10)
