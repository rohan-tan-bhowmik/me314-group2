...
class PixelToCoordNode(Node):
    def __init__(self):
        ...
        self.CoinObjectCenter = "/image_coin_center"
        ...
        self.create_subscription(Point, self.CoinObjectCenter, lambda msg: self.getPointInBaseFrame(msg, "coin"), 10)
        ...
        self.publisher_coin = self.create_publisher(Point, 'coin_position', 10)
    ...
    def getPointInBaseFrame(self, point, objectType):
        ...
        if (objectType == "coin"):
            #self.get_logger().info("COIN@!!!!!!@!")
            self.publisher_coin.publish(coord)
